package br.com.patterns.command.migration;

import java.util.LinkedHashMap;
import java.util.List;
import java.util.Map;

import br.com.patterns.command.migration.commands.ProductTable;
import br.com.patterns.command.migration.commands.UserTable;
import br.com.patterns.command.migration.commands.UserTableRoleColumn;
