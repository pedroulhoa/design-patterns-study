package br.com.patterns.command.alexa.before.alexa;

import java.util.HashMap;
import java.util.Map;

import br.com.patterns.command.alexa.before.lights.PhillipsHueLight;
import br.com.patterns.command.alexa.before.lights.XiaomiLight;
